...
#import "ThirdDaySessionsAgenda.h"
...
@implementation ThirdDaySessionsAgenda
...
- (void)viewDidLoad {
    ...
    NSArray * dbSessions =  (NSArray *) [[SessionDAO new] getSessionsByDate:DAY_THREE];
