...
#import "ThirdDaySessionsMyAgenda.h"
...
@interface ThirdDaySessionsMyAgenda ()
{
...
@implementation ThirdDaySessionsMyAgenda
...
- (void)viewDidLoad {
    ...
    NSArray * dbSessions =  (NSArray *) [[SessionDAO new] getUserSessionsByDate:DAY_THREE];
    if (dbSessions) {
        sessions = dbSessions;
    }else{
...
-(void)reloadTableView{
    sessions =  (NSArray *) [[SessionDAO new] getUserSessionsByDate:DAY_THREE];
